...
export class Init1733816033432 implements MigrationInterface {
    name = 'Init1733816033432'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movie" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "id" SERIAL NOT NULL, "title" character varying NOT NULL, "likeCount" integer NOT NULL DEFAULT '0', "disLikeCount" integer NOT NULL DEFAULT '0', "movieFilePath" character varying NOT NULL, "detailId" integer NOT NULL, "directorId" integer NOT NULL, "creatorId" integer, CONSTRAINT "UQ_a81090ad0ceb645f30f9399c347" UNIQUE ("title"), CONSTRAINT "REL_87276a4fc1647d6db559f61f89" UNIQUE ("detailId"), CONSTRAINT "PK_cb3bb4d61cf764dc035cbedd422" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "movie" ADD CONSTRAINT "FK_87276a4fc1647d6db559f61f89a" FOREIGN KEY ("detailId") REFERENCES "movie_detail"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
